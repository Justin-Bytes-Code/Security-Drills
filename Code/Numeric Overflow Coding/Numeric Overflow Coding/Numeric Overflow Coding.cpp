...
T add_numbers(T const& start, T const& increment, unsigned long int const& steps)
{
    ...
    for (unsigned long int i = 0; i < steps; ++i)
    {
        ...
        {
            //Informs User of Overflow Warning.
            std::cout << " \033[31m OVERFLOW WARNING!!! \033[0m ";
            std::cout << " \033[31m \nReturning Maximum Data Type Value Instead...\n \033[0m ";
            result = max;
        }
        else
        {
...
T subtract_numbers(T const& start, T const& decrement, unsigned long int const& steps)
{
    ...
    for (unsigned long int i = 0; i < steps; ++i)
    {
        ...
        //Detecting Underflow
        if (decrement > 0 && result < lowest + decrement)
        {
            //Informs User of Underflow Warning.
            std::cout << " \033[31m UNDERFLOW WARNING!!! \033[0m ";
            std::cout << " \033[31m \nReturning Minimum Data Type Value Instead...\n \033[0m ";
            return lowest;
        }
